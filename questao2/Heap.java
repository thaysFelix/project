...
public class Heap <T extends Comparable<T>>  {
    ...
    public static void main(String[] args) {
        ...
        try {
	        ...
	        while(heap.size() > 0) {
                System.out.println("GET " + heap.get(0));
    ...
    //Exceção para o caso de overflow
    public boolean insert(T e) throws Excecao  {
        if (size < elements.length) {
        	...
        	throw new Excecao("Limite maximo atingido");
        }
    }
    ...
    //Exceção para o caso de underflow
    public T get(int index) throws Excecao  {
    	if(index < 0) {
    		throw new Excecao("Underflow");
    	} else {
    		return elements[0];
    	}
